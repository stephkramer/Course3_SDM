...
root_wd <- "E:/PopDynIZW Dropbox/Teaching/_TU_BiodivDynamics"
# relative to work-wd
...
output_wd <- 'E:/PopDynIZW Dropbox/Steph Kramer/_GitHub/output'
...
# workaround for slow computers. First, aggregate the 1 km resolution into  
...
What do you actually see? Which method was used? Check the help! (?pairs -> raster package). You will see the help is not very helpful, you have to search inside the 'cor()' function. There you see you can set the argument:

```{r}
raster::pairs(agg_pred, method = 'kendall')
```
